"""
manuscript_vertical_cross_section_continious_bootstrapped.py:

This script is used to generate the vertical cross section of the bootstrapped catalog of the cntinious test.
"""
import json
