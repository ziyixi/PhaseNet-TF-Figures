"""
manuscript_vertical_cross_section_1hour_relocated.py:

This script is used to generate the vertical cross section of the relocated catalog of the 1-hour test.
"""
import json
