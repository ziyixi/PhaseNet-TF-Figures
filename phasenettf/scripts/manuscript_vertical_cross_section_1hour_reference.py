"""
manuscript_vertical_cross_section_1hour_reference.py:

This script is used to generate the vertical cross section of the reference catalog of the 1-hour test.
"""
import json
