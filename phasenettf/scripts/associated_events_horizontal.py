""" 
associated_events_horizontal.py

Plot the horizontal distribution of associated events.
"""
...
CATALOG_FILE = resource(
    ["catalog", "tomoDD.all_months_threshold0.loc"], normal_path=True, check=True
)
LINES = [
    [-179, -16, -173, -19],
    [-179.5, -17, -173.5, -20],
...
def main():
    ...
    save_path(fig, "associated_all_months_threshold0_horizontal", suffix="pdf")
