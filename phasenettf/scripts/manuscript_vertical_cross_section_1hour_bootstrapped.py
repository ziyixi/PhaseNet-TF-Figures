"""
manuscript_vertical_cross_section_1hour_bootstrapped.py:

This script is used to generate the vertical cross section of the bootstrapped catalog of the 1-hour test.
"""
import json
