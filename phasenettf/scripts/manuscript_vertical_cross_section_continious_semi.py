"""
manuscript_vertical_cross_section_continious_semi.py:

This script is used to generate the vertical cross section of the semi catalog of the cntinious test.
"""
import json
