"""
manuscript_vertical_cross_section_continious_associated.py:

This script is used to generate the vertical cross section of the associated catalog of the cntinious test.
"""
import json
